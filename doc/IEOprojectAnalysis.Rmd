...
Finally, for each pair of stages, we will also look at the the top 7 fold-change genes previously extracted. (This is more of an analysis that we simply did becuase of interest in how much the enrichemnt is related to the fold-change of a gene.)
