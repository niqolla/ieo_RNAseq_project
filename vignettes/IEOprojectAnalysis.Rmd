...
In this stage, we also find that there is an increase in the translational activity and overall ribosomal proteins. (Tables \@ref(tab:CTGOtab), \@ref(tab:CTKEGGtab), \@ref(tab:TMGOtab), \@ref(tab:TMKEGGtab))
