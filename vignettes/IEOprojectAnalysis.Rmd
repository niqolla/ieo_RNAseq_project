...
We now perform an analysis to observe differential expressed (DE) genes by excluding each of the 3 lactation stages one by one. Firstly, we observed stage 1 and 2 that correspond to colostrum and transitional stage, leaving out the maturation stage (stage 3). Afterwards, we excluded colostrum stage (stage 1) and finally we excluded transitional stage (stage 2).
