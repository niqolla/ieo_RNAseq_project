...
Checking the distribution of differentially expressed genes. In Figure \@ref(fig:CThist) we analyse the differential expression between Colostrum and Transitional.
