...
plot(sampleDendrogram, main="Hierarchical clustering of the samples by technical factor - protocol used.",
...
plot(sampleDendrogram, main="Hierarchical clustering of the samples by biological factor - lactation stage.")
