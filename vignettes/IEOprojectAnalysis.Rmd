...
As well as several catabolic processes, suggesting natural pre-digestion of milk proteins [@Dallas2013]. (Tables \@ref(tab:CTGOtab), \@ref(tab:CTKEGGtab), \@ref(tab:CMGOtab), \@ref(tab:CMGKEGGtab))
