...
We will study the differential expression between the lactation stages comparing them in groups of 2. So we will first compare Colostrum and Transitional stages, then Transitional and Mature and finally Colostrum and Mature.
...
In the following table the DE genes with lowest p-values are displayed:
...
Differentially expressed genes in the three comparisons above we observe:

- Colostral-Transitional 7173 DE genes
- Transitional-Mature 1463 DE genes
- Colostral-Mature 8527 DE genes.

These values we obtained are quite consistent with the reported DE genes from the atricle. Even the number are quite large, we think it makes sense because of the nature of the tissue. The milk should adap to the infant's needs.
