...
```
From the plot above we don't notice any biases related to the different lactation stages. The only thing that stands out is SRR801705 as having very low sequence depth. In the later part of the analysis we will remove it since it seems to be an error.
