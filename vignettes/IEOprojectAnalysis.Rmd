...
Briefly,
postpartum timing of sample collection ranged between 41–52
hours for colostral, 39–56 hours for transitional, and 33–130 days
for mature; and Na:K ratio ranged between 5.5–9.6 for colostral,
0.70–1.15 for transitional, and 0.19–0.57 for mature.

this study is important because it establishes protocols for extracting RNA from milk and processing it for RNA-seq

***

Stage-specific transcripts are associated with immune
...
stage, and the production of lipids during mature lactation. 

lactation-stage specific transcripts are
associated with immune defense during the colostral stage, the up-
regulation of massive milk protein synthesis during the transitional
stage, and the full-scale production lipids and other factors during
the mature stage of lactation


* FURTHERMORE:
In this paper, we describe the extraction and sequencing of
high-quality RNA from the human milk fat layer over three stages
of milk production, demonstrating the significance of defining
lactation stage based on biochemical parameters (versus postpar-
tum day). 
We then characterize the RNA-Seq transcriptome
responsible for the production of biochemically-defined colostrum,
transitional, and mature milk in humans, including: a) demon-
strating how RNA-Seq captures the broad dynamic range of gene
expression within the temporal context of secretory activation and
lactation; b) functional enrichments of distinct gene expression
trajectories; c) differential expression of insulin signaling genes; and
d) differential expression of lactose synthesis genes
---> mention what we don't do (c, d)
