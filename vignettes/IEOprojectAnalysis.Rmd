...
With some trial and error, we decided to set the size to be [3, 100] and the count >= 25. 
The size represents the number of genes in the pathway, and the count is the number of genes that we calculate as DE.
