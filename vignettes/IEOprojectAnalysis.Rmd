...
In the Table \@ref(tab:CTGKEGGtab) below, the top 10 KEGG results (sorted by Odds Ratio) are displayed:

```{r CTGKEGGtab, echo=FALSE}
...
In the Table \@ref(tab:TMGKEGGtab) below, the top 10 KEGG results (sorted by Odds Ratio) are displayed:

```{r TMGKEGGtab, echo=FALSE}
ktab <- kable(KEGGresults_with_genes, "html", caption="GO results.")
ktab <- kable_styling(ktab, bootstrap_options=c("stripped", "hover", "responsive"), fixed_thead=TRUE)
