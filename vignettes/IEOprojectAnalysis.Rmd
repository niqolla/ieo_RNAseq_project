...
In the Table \@ref(tab:TOP7CTKEGG) we see the GO terms related to the top 7 fold-change genes between Colostrum and Transitional.
...
In the Table \@ref(tab:TOP7TMGO) we see the GO terms related to the top 7 fold-change genes between Transitional and Mature
