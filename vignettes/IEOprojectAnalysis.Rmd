...
In the Table \@ref(tab:TOP7TMGO) we see the GO terms related to the top 7 fold-change genes between Transitional and Mature. We don't display the table, because it's empty.
...
In the Table \@ref(tab:TOP7TMKEGG) we see the KEGG terms related to the top 7 fold-change genes between Transitional and Mature. We don't display the table, because it's empty.
