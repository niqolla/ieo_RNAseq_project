...
## ----pdistCOV2NHBE, echo=FALSE, out.width="600px", fig.cap="Distribution of raw p-values for an F-test on every gene between SARS-Cov-2 infected and mock samples in NHBE cell lines."----
hist(pv, main="", las=1)
...
## ----DEgenesSARScov2NHBE, echo=FALSE------------------------------------------
